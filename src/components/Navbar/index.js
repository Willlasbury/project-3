...
<nav class="bg-blue-500 dark:bg-blue-300 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="nav nav-tabs flex flex-grow justify-center m-4 ">
      ...
      <button className='nav-item px-3 border-4 border-gray-700 rounded-lg shadow-lg bg-grey-300 hover:font-bold hover:bg-blue-400 text-xl font-medium hover:text-2xl' onClick={handleLogout}>Logout</button>
    </ul>
  </div>
  </div>
</nav>
