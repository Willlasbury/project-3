...
export default function Notification({ token, yourOffers, offers, socket }) {
  return (
    <main className="flex flex-row justify-center items-start mt-5">
      <section className="flex flex-col border-2 border-black mx-auto p-4 max-w-sm border-stone-950 bg-amber-100 rounded-lg shadow-lg text-center">
      ...
      <section className="flex flex-col border-2 border-black card mx-auto p-4 max-w-sm border-stone-950 bg-amber-100 rounded-lg shadow-lg text-center">
        <h2 className="px-3 border-4 border-stone-950 rounded-lg shadow-lg bg-amber-100 text-xl font-bold">
          Your Offers
        </h2>
